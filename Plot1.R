#Reading, naming and subsettingdata
...
#Basic plot function
hist(as.numeric(as.character(subactivepower$Global_active_power)),col="red",main="Global Active Power",xlab="Global Active Power(kilowatts)")
