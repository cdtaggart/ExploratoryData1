...
# Basic plot function calling different functions to build each plot
with(subActivePower,{
  ...
  plot(subActivePower$Time,as.numeric(as.character(subpower$Global_reactive_power)),type="l",xlab="datetime",ylab="Global_reactive_power")
})
